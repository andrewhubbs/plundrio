...
// AddTransfer adds a new transfer (torrent) to Put.io and returns the transfer info
func (c *Client) AddTransfer(magnetLink string, folderID int64) (*putio.Transfer, error) {
